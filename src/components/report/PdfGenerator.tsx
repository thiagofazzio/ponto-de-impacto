...
export const PdfGenerator: React.FC<PdfGeneratorProps> = ({ result, onClose }) => {
  ...
  const handleDownloadPdf = async () => {
    ...
    try {
      // Captura APENAS o conteúdo do PDF, ignorando os botões e a caixa externa
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Conteúdo do PDF (Apenas isso será capturado) */}
      <div 
        ref={contentRef} 
        id="pdf-content"
        className="bg-white text-[#1A1A1A] p-8 mx-auto max-w-[210mm] min-h-[297mm] space-y-4 font-sans text-xs shadow-2xl"
        style={{
          backgroundColor: '#ffffff',
          width: '210mm',
          minHeight: '297mm',
