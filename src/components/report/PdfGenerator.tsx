...
export const PdfGenerator: React.FC<PdfGeneratorProps> = ({ result, onClose }) => {
  ...
  const handleDownloadPdf = async () => {
    ...
    try {
      ...
      // 🔥 CAPTURA APENAS A ÁREA VISÍVEL (sem os botões e bordas)
      ...
      // 🔥 SE TIVER MAIS CONTEÚDO, ADICIONA PÁGINAS EXTRAS
      while (heightLeft > 0) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* 🔥 PRÉ-VISUALIZAÇÃO (IGUAL AO PRINT QUE VOCÊ MANDOU) */}
