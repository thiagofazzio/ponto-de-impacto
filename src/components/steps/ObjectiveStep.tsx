...
const ObjectiveStep: React.FC<ObjectiveStepProps> = ({ mainGoal, biggestDifficulty, onUpdate, onNext }) => {
  ...
  const isValid = selectedGoal && selectedDifficulty && 
    (selectedGoal !== 'outro_objetivo' || customGoal.trim()) &&
    (selectedDifficulty !== 'outro_desafio' || customDifficulty.trim());
