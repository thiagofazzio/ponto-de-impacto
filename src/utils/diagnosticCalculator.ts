  ...
  const defaultPlans: Record<string, ActionPlan90Days> = {
    Financeiro: {
      phase1: {
        ...
        tasks: [
          { id: 'f1-1', title: 'Mapeamento Geral de Custos', description: 'Listar todos os custos fixos, assinaturas, pró-labore e despesas recorrentes.', priority: 'Alta' },
          { id: 'f1-2', title: 'Revisão de Precificação', description: `Ajustar preços para garantir margem de contribuição acima de ${Math.max(30, breakEven.contributionMarginPercent)}%.`, priority: 'Alta' },
          { id: 'f1-3', title: 'Separação de PF e PJ', description: 'Fixar o valor exato do Pró-Labore dos sócios e proibir retiradas aleatórias no caixa da empresa.', priority: 'Alta' },
        ],
      },
      phase2: {
        phaseNumber: 2,
        ...
        tasks: [
          { id: 'f2-1', title: 'Projeção de Caixa a 90 Dias', description: 'Criar planilha ou sistema com previsão semanal de entradas e saídas.', priority: 'Alta' },
          { id: 'f2-2', title: 'Renegociação de Fornecedores', description: 'Revisar contratos com fornecedores buscando prazos maiores ou desconto para pagamento à vista.', priority: 'Média' },
          { id: 'f2-3', title: 'Criação de Reserva Operacional', description: 'Destinar de 5% a 10% do lucro mensal para construir reserva de emergência equivalente a 3 meses de custos fixos.', priority: 'Média' },
        ],
      },
      phase3: {
        phaseNumber: 3,
        ...
        tasks: [
          { id: 'f3-1', title: 'Definição de Teto Orçamentário', description: 'Fixar limite máximo de gastos por setor (marketing, operação, administrativo).', priority: 'Média' },
          { id: 'f3-2', title: 'Política de Distribuição de Lucros', description: 'Criar regras claras para distribuição semestral de dividendos atreladas ao cumprimento de metas.', priority: 'Normal' },
        ],
      },
    },
    ...
    Comercial: {
      phase1: {
        ...
        tasks: [
          { id: 'c1-1', title: 'Mapeamento do Processo Comercial', description: 'Definir as etapas exatas do cliente: Prospecção -> Qualificação -> Proposta -> Fechamento.', priority: 'Alta' },
          { id: 'c1-2', title: 'Implementação de CRM de Vendas', description: 'Cadastrar todas as negociações em um CRM (ex: Pipedrive, RD Station CRM ou HubSpot) e eliminar anotações soltas.', priority: 'Alta' },
          { id: 'c1-3', title: 'Criação da Oferta Irresistível', description: 'Refinar a proposta de valor destacando diferenciais claros e reduzindo a objeção de preço.', priority: 'Alta' },
        ],
      },
      phase2: {
        phaseNumber: 2,
        ...
        tasks: [
          { id: 'c2-1', title: 'Script e Playbook de Vendas', description: 'Documentar as principais objeções de clientes e criar respostas padrão testadas.', priority: 'Alta' },
          { id: 'c2-2', title: 'Canal Ativo de Geração de Leads', description: 'Ativar campanhas no Google Ads/Meta Ads ou implementar prospecção ativa B2B.', priority: 'Média' },
          { id: 'c2-3', title: 'Rituais Diários de Vendas', description: 'Realizar reuniões diárias de 15 min (Daily) para acompanhar meta de contatos e propostas enviadas.', priority: 'Média' },
        ],
      },
      phase3: {
        phaseNumber: 3,
        ...
        tasks: [
          { id: 'c3-1', title: 'Estratégia de Upsell e Cross-sell', description: 'Criar pacotes complementares para oferecer aos clientes no momento da compra.', priority: 'Média' },
          { id: 'c3-2', title: 'Programa de Indicação Sistemática', description: 'Pedir indicações ativas a 100% dos clientes satisfeitos logo após o momento do contrato/entrega.', priority: 'Normal' },
        ],
      },
    },
    ...
    Operacao: {
      phase1: {
        ...
        tasks: [
          { id: 'o1-1', title: 'Mapeamento de Fluxo do Cliente', description: 'Desenhar passo a passo desde o fechamento do contrato até a entrega final.', priority: 'Alta' },
          { id: 'o1-2', title: 'Criação dos 5 POPs Cruciais', description: 'Escrever Procedimentos Operacionais Padrão para as atividades mais frequentes.', priority: 'Alta' },
          { id: 'o1-3', title: 'Redução de Retrabalhos', description: 'Identificar a causa raiz das 3 reclamações ou falhas mais recorrentes e eliminar a origem.', priority: 'Alta' },
        ],
      },
      phase2: {
        phaseNumber: 2,
        ...
        tasks: [
          { id: 'o2-1', title: 'Implantação de Gestão de Tarefas', description: 'Centralizar entregas em ferramenta como Trello, Asana, Monday ou ClickUp.', priority: 'Alta' },
          { id: 'o2-2', title: 'Automação de Comunicação com Cliente', description: 'Enviar confirmações, atualizações de status e boletos de forma automatizada.', priority: 'Média' },
          { id: 'o2-3', title: 'Pesquisa de Satisfação NPS', description: 'Coletar nota de satisfação de todos os clientes pós-entrega para identificar melhorias.', priority: 'Média' },
        ],
      },
      phase3: {
        phaseNumber: 3,
        ...
        tasks: [
          { id: 'o3-1', title: 'Otimização de Prazos de Entrega', description: 'Reduzir em 20% o tempo total de produção ou prestação de serviço mantendo a qualidade.', priority: 'Média' },
          { id: 'o3-2', title: 'Gestão de Capacidade Máxima', description: 'Definir o teto saudável de clientes atendidos simultaneamente por funcionário/equipe.', priority: 'Normal' },
        ],
      },
    },
    ...
    Gestao: {
      phase1: {
        ...
        tasks: [
          { id: 'g1-1', title: 'Definição dos 5 KPIs Vitais', description: 'Estabelecer os indicadores cruciais: Faturamento, Margem Líquida, CAC, Vendas Novas e Retenção.', priority: 'Alta' },
          { id: 'g1-2', title: 'Implementação da Reunião de Gestão Semanal', description: 'Agendar reunião fixa de 45 min toda segunda-feira para analisar indicadores com a liderança.', priority: 'Alta' },
          { id: 'g1-3', title: 'Matriz de Responsabilidades (RACI)', description: 'Definir quem responde exatamente por qual área e projeto dentro da empresa.', priority: 'Alta' },
        ],
      },
      phase2: {
        phaseNumber: 2,
        ...
        tasks: [
          { id: 'g2-1', title: 'Plano de Metas Trimestrais (OKRs)', description: 'Definir 3 objetivos estratégicos para os próximos 90 dias com metas mensuráveis.', priority: 'Alta' },
          { id: 'g2-2', title: 'Centralização de Informações e Documentos', description: 'Criar wiki/drive organizado com senhas, relatórios e processos acessíveis.', priority: 'Média' },
          { id: 'g2-3', title: 'Auditoria Mensal de Resultados', description: 'Revisar mensalmente o desvio entre o planejado vs executado.', priority: 'Média' },
        ],
      },
      phase3: {
        phaseNumber: 3,
        ...
        tasks: [
          { id: 'g3-1', title: 'Conselho Consultivo Mensal', description: 'Realizar reunião formal com mentores ou sócios para revisão de direcionamento estratégico.', priority: 'Média' },
          { id: 'g3-2', title: 'Manual da Cultura e Regimento Interno', description: 'Documentar os valores, código de conduta e diretrizes da empresa para novos colaboradores.', priority: 'Normal' },
        ],
      },
    },
    ...
    Pessoas: {
      phase1: {
        ...
        tasks: [
          { id: 'p1-1', title: 'Descritivos de Cargo Atualizados', description: 'Documentar as atribuições, metas e entregáveis de 100% da equipe.', priority: 'Alta' },
          { id: 'p1-2', title: 'Alinhamento Individual (1on1)', description: 'Realizar conversa individual de 30 minutos com cada liderado para escutar dores e alinhar expectativas.', priority: 'Alta' },
          { id: 'p1-3', title: 'Ajuste de Salários e Variável Básica', description: 'Adequar a remuneração ao mercado e criar comissionamento transparente focado em resultados.', priority: 'Alta' },
        ],
      },
      phase2: {
        phaseNumber: 2,
        ...
        tasks: [
          { id: 'p2-1', title: 'Plano de Integração (Onboarding)', description: 'Criar roteiro de 7 dias para novos contratados aprenderem a cultura e os processos.', priority: 'Alta' },
          { id: 'p2-2', title: 'Trilha de Treinamento Técnico', description: 'Implementar sessão quinzenal de treinamento prático de ferramentas e técnicas de trabalho.', priority: 'Média' },
          { id: 'p2-3', title: 'Delegação Orientada por Níveis', description: 'Transferir formalmente 3 tarefas operacionais dos sócios para os líderes de setor.', priority: 'Média' },
        ],
      },
      phase3: {
        phaseNumber: 3,
        ...
        tasks: [
          { id: 'p3-1', title: 'Avaliação de Desempenho Trimestral', description: 'Avaliar competências técnicas e comportamentais com devolutiva estruturada (Feedback).', priority: 'Média' },
          { id: 'p3-2', title: 'Plano de Carreira e Crescimento', description: 'Apresentar aos destaques os critérios para futuras promoções e bônus.', priority: 'Normal' },
        ],
      },
    },
    ...
    Estrategia: {
      phase1: {
        ...
        tasks: [
          { id: 'e1-1', title: 'Definição das Metas Anuais', description: 'Fixar metas de faturamento, margem e número de clientes para o ano.', priority: 'Alta' },
          { id: 'e1-2', title: 'Pesquisa com Clientes Atuais', description: 'Entrevistar os 10 melhores clientes para entender por que escolheram a empresa e o que mais valorizam.', priority: 'Alta' },
          { id: 'e1-3', title: 'Análise de Nicho e Especialização', description: 'Focar na solução do problema mais lucrativo e com menor concorrência direta.', priority: 'Alta' },
        ],
      },
      phase2: {
        phaseNumber: 2,
        ...
        tasks: [
          { id: 'e2-1', title: 'Mapeamento de Motores de Crescimento', description: 'Identificar quais canais (vendas diretas, parcerias, marketing digital) trarão 80% dos resultados.', priority: 'Alta' },
          { id: 'e2-2', title: 'Comitê de Inovação e Novos Produtos', description: 'Desenvolver ou empacotar novos serviços de maior margem para a base atual de clientes.', priority: 'Média' },
          { id: 'e2-3', title: 'Desconexão Progressiva do Operacional', description: 'Bloquear 2 tardes por semana na agenda do empresário exclusivamente para planejamento e reuniões estratégicas.', priority: 'Média' },
        ],
      },
      phase3: {
        phaseNumber: 3,
        ...
        tasks: [
          { id: 'e3-1', title: 'Teste de Autonomia de 7 Dias', description: 'Empresário se ausenta das rotinas diárias operacionais por 1 semana inteira para testar a resiliência dos processos.', priority: 'Média' },
          { id: 'e3-2', title: 'Plano de Expansão e Investimentos', description: 'Reinvestir os lucros acumulados na ampliação do canal comercial e contratação de talentos chave.', priority: 'Normal' },
        ],
      },
    },
  };
  ...
  if (!plano) {
    ...
    return {
      phase1: {
        ...
        period: 'Dias 1 a 30',
        goal: 'Organizar as bases da empresa para crescer com segurança.',
        tasks: [
          { id: 'fallback-1', title: 'Mapeamento Geral', description: 'Mapear todos os processos e custos da empresa.', priority: 'Alta' },
          { id: 'fallback-2', title: 'Definir Metas Claras', description: 'Estabelecer metas claras para os próximos 90 dias.', priority: 'Alta' },
          { id: 'fallback-3', title: 'Revisão de Indicadores', description: 'Definir e revisar os principais indicadores de desempenho.', priority: 'Alta' },
        ],
      },
      phase2: {
        phaseNumber: 2,
        title: 'Estruturação da Gestão',
        period: 'Dias 31 a 60',
        goal: 'Implantar rotinas de gestão e acompanhamento de resultados.',
        tasks: [
          { id: 'fallback-4', title: 'Rotina de Reuniões', description: 'Implantar reuniões semanais de acompanhamento de resultados.', priority: 'Alta' },
          { id: 'fallback-5', title: 'Indicadores de Desempenho', description: 'Definir e acompanhar indicadores de desempenho.', priority: 'Média' },
          { id: 'fallback-6', title: 'Plano de Ação', description: 'Definir e acompanhar planos de ação para cada área.', priority: 'Média' },
        ],
      },
      phase3: {
        phaseNumber: 3,
        ...
        period: 'Dias 61 a 90',
        goal: 'Preparar a empresa para crescer com autonomia e processos definidos.',
        tasks: [
          { id: 'fallback-7', title: 'Autonomia da Equipe', description: 'Definir responsabilidades e autonomia para cada área.', priority: 'Média' },
          { id: 'fallback-8', title: 'Plano de Expansão', description: 'Definir o plano de expansão para os próximos 12 meses.', priority: 'Normal' },
        ],
      },
    };
  }
